  ...
  var TRANSLATIONS = {
    en: {
      ...
      testimonials: {
        ...
        subheading: "Real drivers. Real stories. See why LA trusts SLY Transportation Services."
      },
      about: {
      ...
      applyModal: {
        ...
        sendingCode: "Sending\u2026",
        sentDone:    "Sent \u2713",
        licenseTypeError:   "Please upload a photo or image of your license (JPG, PNG, HEIC, WebP, etc.) or a PDF.",
        licenseSizeError:   "File is too large. Please upload an image under 8\u00a0MB.",
      ...
      booking: {
        ...
        accepted: "Accepted: JPG, PNG, PDF, HEIC, WebP",
        ...
        cardAuthorizationNotice: "By booking, you authorize SLY Transportation Services to charge your card for any applicable late fees or extensions.",
        ...
        alertIdType:          "Please upload a photo or image of your ID (JPG, PNG, HEIC, WebP, etc.) or a PDF",
        alertFileSize:        "File is too large to upload.",
        alertInsuranceType:   "Please upload a photo or image of your insurance card (JPG, PNG, HEIC, WebP, etc.) or a PDF",
    ...
    es: {
      ...
      testimonials: {
        ...
        subheading: "Conductores reales. Historias reales. Descubre por qu\u00E9 LA conf\u00EDa en SLY Transportation Services."
      },
      about: {
      ...
      applyModal: {
        ...
        sentDone:    "Enviado \u2713",
        licenseTypeError:   "Por favor sube una foto o imagen de tu licencia (JPG, PNG, HEIC, WebP, etc.) o un PDF.",
        licenseSizeError:   "El archivo es muy grande. Por favor sube una imagen menor de 8\u00a0MB.",
      ...
      booking: {
        ...
        accepted: "Aceptados: JPG, PNG, PDF, HEIC, WebP",
        ...
        cardAuthorizationNotice: "Al reservar, autorizas a SLY Transportation Services a cobrar tu tarjeta por cualquier cargo por demora o extensión aplicable.",
        ...
        alertIdType:          "Por favor sube una foto o imagen de tu identificaci\u00F3n (JPG, PNG, HEIC, WebP, etc.) o un PDF",
        alertFileSize:        "El archivo es demasiado grande para subir.",
        alertInsuranceType:   "Por favor sube una foto o imagen de tu seguro (JPG, PNG, HEIC, WebP, etc.) o un PDF",
