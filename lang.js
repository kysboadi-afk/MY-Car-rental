  ...
  var TRANSLATIONS = {
    en: {
      ...
      fleet: {
        ...
        waitlistDeposit:    "Reserve for $50 Deposit",
        waitlistHeading:    "🔔 Reserve Next Availability",
        waitlistSubtitle:   "This vehicle is currently booked. Pay a $50 non-refundable deposit to lock your place in line — it goes toward your rental when the car becomes available.",
        waitlistNextLine:   "Next available: {date}",
        waitlistQueueNote:  "First come, first served. You'll receive a payment link when the car is ready for your dates.",
        waitlistPrefPickup: "Preferred Pickup Date",
        waitlistPrefReturn: "Preferred Return Date",
        waitlistJoinBtn:    "🔒 Reserve My Spot — $50 Deposit",
    ...
    es: {
      ...
      fleet: {
        ...
        waitlistDeposit:    "Reservar por $50 de Depósito",
        waitlistHeading:    "🔔 Reserva la Próxima Disponibilidad",
        waitlistSubtitle:   "Este vehículo está actualmente reservado. Paga un depósito no reembolsable de $50 para asegurar tu lugar — se aplica al alquiler cuando el auto esté disponible.",
        ...
        waitlistJoinBtn:    "🔒 Reservar mi Lugar — $50 de Depósito",
