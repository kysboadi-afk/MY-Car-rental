  ...
  var TRANSLATIONS = {
    en: {
      ...
      agreement: {
        ...
        mileageFuelHeading: "MILEAGE &amp; FUEL",
        mileageLimitBody: "<strong>Mileage Limit:</strong> Unlimited miles are included; however, all driving must remain within the state of California. Driving the vehicle out of state is strictly prohibited and will result in a <strong>$250 penalty charge</strong>.",
        fuelPolicyBody: "<strong>Fuel Policy:</strong> Return the vehicle with the same fuel level as at pickup, or pay a $5/gallon replacement fee.",
    ...
    es: {
      ...
      agreement: {
        ...
        mileageFuelHeading: "MILLAJE Y COMBUSTIBLE",
        mileageLimitBody: "<strong>L\u00EDmite de Millaje:</strong> Se incluyen millas ilimitadas; sin embargo, todo el manejo debe realizarse dentro del estado de California. Conducir el veh\u00EDculo fuera del estado est\u00E1 estrictamente prohibido y resultar\u00E1 en un <strong>cargo de penalizaci\u00F3n de $250</strong>.",
        fuelPolicyBody: "<strong>Pol\u00EDtica de Combustible:</strong> Devuelve el veh\u00EDculo con el mismo nivel de combustible que al recogerlo, o paga una tarifa de reemplazo de $5/gal\u00F3n.",
