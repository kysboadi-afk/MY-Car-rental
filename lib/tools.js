...
export const TOOL_DEFINITIONS = [
  ...
  },
  {
    ...
    function: {
      name: "create_vehicle",
      description:
        "Create a new car in the main rental fleet. Type defaults to \"car\". Requires admin confirmation before executing.",
      parameters: {
        type: "object",
        properties: {
          name: {
          ...
          type: {
            type: "string",
            description:
              'Vehicle type. Defaults to "car". Use "car" for standard rentals. Do NOT use "slingshot" — slingshotss are managed separately.',
          },
          price_per_day: {
            type: "number",
          ...
          metadata: {
            type: "object",
            description: "Optional extra fields to store on the vehicle (e.g. { purchase_price: 8000, notes: \"recently serviced\" }).",
          },
          confirmed: {
            type: "boolean",
