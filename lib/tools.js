...
export const TOOL_DEFINITIONS = [
  ...
  },
  {
    ...
    function: {
      ...
      description:
        "Recover missing stripe_customer_id and stripe_payment_method_id for Stripe bookings by " +
        "looking up each booking's PaymentIntent in Stripe and writing back the customer/card references. " +
        ...
        "Use this when the admin asks to 'backfill cards', 'recover saved cards', or 'fix missing payment methods'.",
      parameters: {
        type: "object",
        properties: {
          action: {
