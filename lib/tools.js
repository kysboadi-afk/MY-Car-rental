...
export const TOOL_DEFINITIONS = [
    ...
    function: {
      ...
      parameters: {
        ...
        properties: {
          vehicle_id: {
            type: "string",
            description: "Optional. Explicit vehicle ID to use (lowercase letters, digits, hyphens only; e.g. \"camry2014\"). If omitted, one is auto-generated from the name. When provided, this exact ID is used — always pass this when following the ADD_NEW_VEHICLE flow.",
          },
          name: {
            type: "string",
  ...
  },
  {
    ...
    function: {
      name: "add_expense",
      description:
        "Log a new expense record for a fleet vehicle (e.g. oil change, insurance payment, fuel cost). Requires admin confirmation before executing.",
      parameters: {
        type: "object",
        properties: {
          vehicle_id: {
            type: "string",
            description: 'Vehicle ID the expense belongs to (e.g. "camry", "slingshot").',
          },
          date: {
            type: "string",
          ...
          category: {
            type: "string",
            enum: ["maintenance", "insurance", "repair", "fuel", "registration", "other"],
    ...
    function: {
      ...
      parameters: {
        ...
        properties: {
          vehicleId: {
            type: "string",
            description: 'Vehicle ID to block (e.g. "camry", "slingshot2").',
          },
          from: {
            type: "string",
    ...
    function: {
      ...
      parameters: {
        ...
        properties: {
          vehicleId: {
            type: "string",
            description: 'Vehicle ID to unblock (e.g. "camry", "slingshot2").',
          },
          from: {
            type: "string",
  ...
  },
  {
    ...
    function: {
      name: "delete_vehicle",
      description:
        "Permanently delete a vehicle from the fleet. This removes the vehicle from Supabase and vehicles.json. Core Slingshot units (slingshot, slingshot2, slingshot3) cannot be deleted this way. Requires admin confirmation before executing.",
      parameters: {
        type: "object",
        properties: {
          vehicleId: {
    ...
    function: {
      ...
      parameters: {
        ...
        properties: {
          ...
          vehicleId: {
            type: "string",
            description: 'Optional vehicle ID (e.g. "camry", "slingshot") — helps locate the booking faster.',
          },
          extensionAmount: {
            type: "number",
