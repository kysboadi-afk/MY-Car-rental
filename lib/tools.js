...
export const TOOL_DEFINITIONS = [
  ...
  },
  {
    ...
    function: {
      ...
      description:
        "Manually create a booking record for a cash or offline reservation. Blocks the dates on the calendar, saves the booking, and syncs to Supabase. Use this when a customer pays in cash, books over the phone, or the admin needs to log a booking that wasn't captured through the website.",
      parameters: {
        type: "object",
        properties: {
          vehicleId: {
          ...
          notes: {
            type: "string",
            description: 'Any notes about the booking, e.g. "Cash payment — collected in person" (optional).',
          },
          confirmed: {
            type: "boolean",
