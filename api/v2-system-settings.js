...
const DEFAULT_SETTINGS = [
  ...
  { key: "late_fee_extended",           value: 55,      description: "Late fee assessed after the 3-hour escalation window — equals the vehicle's daily rental rate (USD)", category: "pricing" },
