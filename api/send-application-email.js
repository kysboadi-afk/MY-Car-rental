...
function buildApplicantEmailHtml(decision, firstName) {
  ...
  return `
    ...
    <p>If you have questions or believe this was an error, please contact us at <strong>(844) 511-4059</strong> or email <a href="mailto:${esc(OWNER_EMAIL)}">${esc(OWNER_EMAIL)}</a>.</p>
    <p><strong>Sly Transportation Services LLC Team &#x1F697;</strong></p>
  `;
}
...
function buildApplicantEmailText(decision, firstName) {
  ...
  return [
    ...
    "",
    `If you have questions, please contact us at (844) 511-4059 or email ${OWNER_EMAIL}.`,
    "",
    "— Sly Transportation Services LLC Team",
  ].join("\n");
}
