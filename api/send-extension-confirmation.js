...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (!vehicle_id || !bookingRef) {
      ...
      return res.status(422).json({ error: "Extension metadata is incomplete. Please contact us at (844) 511-4059." });
    }
    ...
    if (!ext) {
      ...
      return res.status(422).json({ error: "Extension details are unavailable. Please contact us at (844) 511-4059." });
    }
    ...
    return res.status(500).json({ error: "Unexpected error. Please contact us at (844) 511-4059." });
  }
}
