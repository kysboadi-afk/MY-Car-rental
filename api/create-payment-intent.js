...
export default async function handler(req, res) {
  ...
  try {
    const { vehicleId, name, email, phone, pickup, returnDate, protectionPlan, protectionPlanTier, paymentMode, insuranceCoverageChoice, pickupTime, returnTime, insuranceFileName, adminOverride, testMode } = req.body;
