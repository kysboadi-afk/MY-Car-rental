...
export default async function handler(req, res) {
  ...
  return res.status(200).json({
    ...
    checkrInvitationUrl: r.checkr_invitation_url || null,
    checkrInvitationSentAt: r.checkr_invitation_sent_at || null,
    checkrInvitationSmsSentAt: r.checkr_invitation_sms_sent_at || null,
    checkrInvitationReminderSentAt: r.checkr_invitation_reminder_sent_at || null,
